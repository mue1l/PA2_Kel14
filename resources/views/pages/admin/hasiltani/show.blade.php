            ...
            <div class="row row-sm">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Hasil Pertanian</h4>
                    </div>
                </div>
                <form id="form_input">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="" class="form-label">Nama Hasil Pertanian</label>
                                <input type="text" name="title" class="form-control"
                                    placeholder="Masukkan Nama Hasil pertanian" value="{{ $data->title }}">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="textarea" name="deskripsi" class="form-control" placeholder="Masukkan deskripsi"
