        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="forms-sample" action="{{ route('admin.pengumuman.update', $pengumuman->id) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="judul"
                                    ...
                                    id="judul" value="{{ $pengumuman->judul }}">
                            </div>
                            @error('judul')
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <textarea type="textarea" name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi"
                                        placeholder="Masukkan deskripsi" id="deskripsi" value="{{ $pengumuman->deskripsi }} "></textarea>
                                </div>
                            </div>
                            @error('deskripsi')
                                <span class="alert alert-danger">
