    ...
    <section class="team-section sec-pad bg-color-1">
        ...
        <div class="auto-container">
            <div class="sec-title">
                ...
                @endif
                <h2>Riwayat Pendaftaran Semua Anak PAUD</h2>
                <div class="title-shape"></div>
                <i class="flaticon-star"></i>
                <a href="{{ url('pembayarandaftar/{pembayarandaftar}') }}" class="theme-btn">Lihat riwayat pendaftaran
                    anak
                    anda</a>
                <br>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="dataTableExample" class="table">
                                        ...
                                        <tbody>
                                            @foreach ($daftarpembayaran as $item)
                                                <tr>
