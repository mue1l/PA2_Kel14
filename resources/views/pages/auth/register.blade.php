    ...
    <body>
        ...
        <div id="main-wrapper" class="oxyy-login-register">
            <div class="hero-wrap d-flex align-items-center">
                ...
                <div class="hero-bg hero-bg-scroll" style="background-image:url('{{ asset('assets/images/bg(1).jpg') }}');">
                </div>
                                            ...
                                            <form action="{{ route('register.custom') }}" method="post">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="name" class="form-control rounded-0"
                                                        id="namalengkap" placeholder="Masukkan nama lengkap anda">
                                                    @error('name')
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="alamat" class="form-control rounded-0" id="alamat" placeholder="Masukkan alamat anda"></textarea>
                                                    @error('alamat')
                                                        <div class="alert alert-danger">
                                                            {{ $message }}
                                                        </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="username" class="form-control rounded-0"
                                                        id="username" placeholder="Masukkan nama pengguna anda">
                                                    @error('username')
                                                        <div class="alert alert-danger">
                                                            {{ $message }}
                                                        </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" name="nomorhp" class="form-control rounded-0"
                                                        id="nohp" placeholder="Masukkan nomor hp anda">
                                                    @error('nomorhp')
                                                        <div class="alert alert-danger">
                                                            {{ $message }}
                                                        </div>
