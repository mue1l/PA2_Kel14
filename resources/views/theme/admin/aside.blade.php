...
<nav class="sidebar">
    ...
    <div class="sidebar-body">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a href="{{ url('admin/profildesa') }}" class="nav-link">
                    <i class="link-icon" data-feather="box"></i>
                    <span class="link-title">Profildesa</span>
                </a>
            </li>
            <li class="nav-item nav-category">Data Penduduk</li>
            <li class="nav-item">
                <a href="{{ url('admin/datapenduduk') }}" class="nav-link">
                    <i class="link-icon" data-feather="box"></i>
                    <span class="link-title">Berdasarkan umur</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ url('admin/datajeniskelamin') }}" class="nav-link">
                    <i class="link-icon" data-feather="box"></i>
                    <span class="link-title">Berdasarkan Jenis Kelamin</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ url('admin/datapekerjaan') }}" class="nav-link">
                    <i class="link-icon" data-feather="box"></i>
                    <span class="link-title">Berdasarkan pekerjaan</span>
                </a>
            </li>
